            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.users.store') }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input name="name" type="text" placeholder="Masukkan nama" class="form-select"></input>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input name="email" type="email" placeholder="Masukkan email" class="form-select"></input>
