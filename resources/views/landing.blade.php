...
<body>
    ...
    <header id="header" class="fixed-top ">
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo me-auto"><a href="index.html">Perdin App</a></h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1"
                    ...
                    <h1>Labore voluptatum architecto suscipit?</h1>
    ...
    <!-- ======= Footer ======= -->
    <footer id="footer">
        <div class="footer-top" style="background-color: #f1f2f6">
            <div class="container">
                <div class="row justify-content-between">
                    ...
                    <div class="col-lg-3 col-md-6 footer-contact">
                        ...
                        <p>
                            ...
                            <strong>Email:</strong> admin@perdin-app.com<br>
                        </p>
                    </div>
